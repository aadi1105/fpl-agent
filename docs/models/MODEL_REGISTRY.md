...
| :--- | :--- | :--- | :--- | :--- |
| **`expected_minutes_baseline_v1`** | Deterministic Heuristic | [`backend/ml/minutes_predictor.py`](file:///C:/Users/RAJIV%20KUMAR/fpl-agent/backend/ml/minutes_predictor.py#L52) | **FALLBACK (PROD)** | Safe production fallback if ML model artifact or inference fails |
